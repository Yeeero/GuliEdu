    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='http://www.atguigu.com', verbose_name='轮播图片链接')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, max_length=200, null=True, upload_to='users/', verbose_name='用户头像')),
                ...
                ('gender', models.CharField(choices=[('girls', '女'), ('boy', '男')], max_length=10, verbose_name='用户性别')),
