    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('cifyinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgs.CityInfo', verbose_name='所在城市')),
            ],
            options={
                'verbose_name': '机构信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(default='boy', max_length=10, verbose_name=(('boy', '男'), ('girl', '女')))),
                ('love_num', models.IntegerField(default=0, verbose_name='收藏数')),
